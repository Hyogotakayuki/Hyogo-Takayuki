...
const CATEGORY_LABELS = { bank: '銀行', stocks: '株式', insurance: '保険', pension: '障害年金' };
const CATEGORY_ICONS = { bank: '🏦', stocks: '📈', insurance: '🛡️', pension: '👴' };
...
const EXPENSE_LABELS = { subscription: 'サブスク', savings: '積立', self_defense: '自己防衛費' };
const EXPENSE_ICONS = { subscription: '📱', savings: '💹', self_defense: '🛡️' };
...
async function loadDashboard() {
  try {
    ...
    // Charts
    const catMap = { bank: '銀行', stocks: '株式', insurance: '保険', pension: '障害年金' };
    const catColors = ['#0f3460', '#e94560', '#4caf50', '#ff9800'];
    const expCatMap = { subscription: 'サブスク', savings: '積立', self_defense: '自己防衛費' };
    const expColors = ['#9c27b0', '#00bcd4', '#ff5722'];
